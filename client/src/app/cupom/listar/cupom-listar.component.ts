  ...
  abrirConfirmacao(modal: any) {
    this.servicoModal.open(modal).result.then((resultado) => {
      if (resultado == 'Excluir') {
        ...
        .subscribe(() =>{
          this.toastService.show('Cupom removido com sucesso', {classname: 'bg-success text-light', delay: 5000});
      ...
      erro => {
        this.toastService.show('Erro ao remover cupom ' + erro.error.errors["Nome"], {classname: 'bg-danger text-light', delay: 5000});
